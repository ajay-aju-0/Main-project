...
urlpatterns = [
   ...
   path('change animal health status/<id>',changeAnimalHealthStatus,name='doctor_change_animal_health_status'),
   ...
   path('medicine consumption details/<id>',viewMedicineConsumption,name='doctor_view_given_medicine'),
   ...
   path('mark medicine expire/<id>',expireMedicine,name='doctor_mark_medicine_expire'),
   path('expired medicines/',viewExpiredMedicines,name='doctor_view_expired_medicines'),
