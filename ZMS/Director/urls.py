...
urlpatterns = [
   ...
   path('update ticket catagory/<id>',UpdateTicketRate,name="director_update_ticket_rate"),
   ...
   path('dismantled enclosures/',dismantledEnclosuresList,name='director_view_dismantled_enclosures'),
